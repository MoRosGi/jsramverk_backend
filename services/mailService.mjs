...
const mailService = {
    sendInvite: async function sendInvite(receiver, inviteId) {
        try {
            const link = `https://www.student.bth.se/~angt23/editor/#/invite/${inviteId}`;

            const msg = await mg.messages.create('sandbox9a319d4452b34ccca15cbcac022c6900.mailgun.org', {
            ...
            throw new Error("Error to test if mail: " + error.message);
        }
    }
};
